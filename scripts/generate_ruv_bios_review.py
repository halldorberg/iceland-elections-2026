...
def render():
    ...
    page = (
        ...
        'function updateCount(){const total=document.querySelectorAll(".card[data-rid]").length;document.getElementById("approved-count").textContent=APPROVED.size;document.querySelector("#count-chip .total").textContent="af "+total;}'
