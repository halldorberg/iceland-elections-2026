...
import { getMunicipalityPartyData } from './data/candidates.js?v=81';
...
let TR = {};
if (lang === 'en') {
  const mod = await import('./data/candidates.en.js?v=15');
  TR = mod.TRANSLATIONS_EN;
} else if (lang === 'pl') {
  const mod = await import('./data/candidates.pl.js?v=15');
