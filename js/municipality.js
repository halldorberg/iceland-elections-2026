...
import { getMunicipalityPartyData } from './data/candidates.js?v=86';
...
let TR = {};
if (lang === 'en') {
  const mod = await import('./data/candidates.en.js?v=20');
  TR = mod.TRANSLATIONS_EN;
} else if (lang === 'pl') {
  const mod = await import('./data/candidates.pl.js?v=20');
