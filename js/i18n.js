...
export const UI = {
  is: {
    ...
    coalitionDetailTableHint:  'Brosmerki sýna opinbera afstöðu flokksins skv. kosningaprófi RÚV. <strong>Bil</strong> = munur milli flokks með hæstu og lægstu afstöðu (0–3). Stjarna ★ undir brosmerki merkir að einhverjir frambjóðendur þess flokks merktu fullyrðinguna mikilvæga.',
  ...
  en: {
    ...
    coalitionDetailTableHint:  'Smileys show the party\'s official stance from RÚV\'s election quiz. <strong>Spread</strong> = gap between the highest- and lowest-positioned party on this proposition (0–3). A ★ under a smiley means at least one of that party\'s candidates flagged this proposition as important.',
  ...
  pl: {
    ...
    coalitionDetailTableHint:  'Emotki pokazują oficjalne stanowisko partii w teście wyborczym RÚV. <strong>Rozpiętość</strong> = różnica między partią o najwyższym i najniższym stanowisku w danym stwierdzeniu (0–3). Gwiazdka ★ pod emotką oznacza, że co najmniej jeden kandydat tej partii uznał to stwierdzenie za ważne.',
