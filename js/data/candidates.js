...
const SNB = {
  ...
  D: {
    ...
    list: [
      [1, 'Haukur Andreásson', 'Lögfræðingur og fasteignasali hjá Allt fasteignir', 'https://xd.is/wp-content/uploads/2023/07/Haukur-Andreasson.jpg', {
        age: null,
        bio: null,
        interests: null,
        social: null,
      ...
      [2, 'Haraldur Helgason', 'Teymisstjóri veitingaþjónustu LSH', null, { age: null, bio: null, interests: null, social: null, news: [] }],
      [3, 'Oddný Kristrún Ásgeirsdóttir', 'Verkefnastjóri Ferðaþjónustu Reykjaness'],
      [4, 'María Kjartansdóttir', 'MSc verkfræðingur og verkefnastjóri framkvæmda hjá Isavia'],
      [5, 'Berglind Lára Haraldsdóttir', 'Deildarstjóri Leikskólans Grænaborg'],
      [6, 'Margrét Edda Arnardóttir', 'Atvinnurekandi og þjálfari'],
      [7, 'Fannar Logi Waldorff Sigurðsson', 'Nýstúdent á 2,5 árum og skógarmaður'],
      [8, 'Arnar Geir Gestsson', 'Pípulagningameistari og eigandi AG pípulagnir'],
      [9, 'Sólmundur Ingi Einvarðsson', 'Framkvæmdastjóri rekstrarsviðs Skólamatar'],
      [10, 'Sigurður Þór Magnússon', 'Framkvæmdastjóri hjá Pallar og plön'],
      [11, 'Bergljót Bára Theódórsdóttir', 'Starfsmaður Leikskólans Grænaborg'],
      [12, 'Guðmundur Torfi Rafnsson', 'Húsasmíðameistari og slökkviliðsmaður'],
      [13, 'Jónatan Már Sigurjónsson', 'Flugöryggisvörður'],
      [14, 'Oliwia Klaudia Fierka', 'Stúdent og starfsmaður Apótekarans'],
      [15, 'Bogi Jónsson', 'Blikksmiður'],
      [16, 'Jón Kristinn Snæhólm', 'Alþjóðastjórnmálafræðingur'],
      [17, 'Gunnar Hámundarson Häsler', 'Ellilífeyrisþegi'],

      [18, 'Einar Jón Pálsson', 'Forseti bæjarstjórnar'],
    ],
  },
  M: {
