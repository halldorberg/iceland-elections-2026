...
const RVK = {
  D: {
    ...
    agenda: [
      { icon: '🚗', title: 'Sundabraut í einkaframkvæmd', text: 'Endurbætur á stofnvegakerfi, efling almenningssamgangna og fleiri hjólastígar; Sundabraut lögð í einkaframkvæmd með hagsmuni borgarbúa og Sundahafnar að leiðarljósi; bílastæðastefna endurskoðuð; göngu- og hjólastígar hitaðir með hreini íslenski orku og/eða affalsvatni; jarðgangagerð í einkaframkvæmd könnuð.' },
      { icon: '🏘️', title: 'Ný hverfi í Geldinganesi, Keldnalandi og Granda', text: 'Öll hverfi skipulögð þannig að íbúar geti nálgast helstu verslun og þjónustu á 15–20 mínútna göngufæri; skipulögð ný hverfi í Geldinganesi, Keldnalandi og Granda, Úlfarsárdalur og Kjalarnes stækkuð; aukin áhersla á séreignarstefnu á húsnæðismarkaði.' },
      { icon: '👶', title: 'Daggæsla á vinnustöðum', text: 'Borgin veiti vinnustöðum stuðning og sveigjanleika til að opna daggæsluúrræði fyrir börn starfsmanna; fjölbreytt úrræði í kjölfar fæðingarorlofs: fleiri leikskólapláss, samstarf við atvinnulíf og heimgreiðslur fyrir þá sem vilja dvelja lengur heima.' },
      { icon: '📚', title: 'Samræmd próf og jafnt framlag til einkarekinna skóla', text: 'Skýr markmið og samræmd próf; borgin miðar að því að koma grunnskólakerfinu í röð þeirra fremstu í Evrópu; borgin greiði sama framlag með öllum börnum óháð því hvort skólinn er borgarrekinn eða einkarekinn; börn sem flytja hingað til lands fari í móttökudeildir með áherslu á íslensku og íslenska menningu.' },
      { icon: '🌳', title: 'Elliðaárdalur sem Central Park Reykjavíkur', text: 'Elliðaárdalur stækkaður og þróaður sem enn öflugra útivistarsvæði; borgin stuðli í auknum mæli að heilsueflingu eldri borgara — reynslan hefur sýnt jákvæð tengsl milli reglulegrar hreyfingar og lífsgæða á efri árum.' },
      { icon: '🏛️', title: 'Selja fyrirtæki borgar í samkeppnisrekstri', text: 'Hið opinbera á ekki að vera þátttakandi á samkeppnismarkaði — borgin selji slík fyrirtæki; lægri fasteignaskattar á atvinnuhúsnæði; einfaldara og sveigjanlegra regluverk; stuðningur við einkaframtak og fjölbreytt rekstrarform í velferðarþjónustu; borgarfulltrúum fækkað aftur í 15 — fjölgunin árið 2018 var kostnaðarsöm og aukti flækjustig.' },
    ],
    list: [
